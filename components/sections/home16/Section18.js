...
export default function Section18() {
	return (
		<>
			...
			<section id="faqs" className="pt-100 faqs-1 faqs-section division">
					...
					<div className="row justify-content-center">
						<div className="col-md-9 col-lg-8">
							<div className="section-title text-center mb-60">
								{/* Title */}
								<h2 className="h2-xl">Troubles with Pintex?</h2>
								{/* Text */}
								...
								<div className="accordion-wrapper">
									<ul className="accordion">
										...
										<li className="accordion-item wow animate__animated animate__fadeInUp">
											...
											<div className="accordion-panel">
												{/* Text */}
												<p>An augue cubilia laoreet and magna suscipit egestas magna ipsum purus and
													felis primis augue ultrice ligula turpis egestas a suscipit lectus gestas
													integer congue a lectus porta neque phasellus blandit tristique
												</p>
												{/* Text */}
												<p>Sagittis congue augue egestas volutpat diam egestas a magna suscipit egestas
													and magna ipsum vitae
												</p>
												{/* Text */}
												<p>Sagittis congue augue and egestas volutpat egestas and magna suscipit egestas
													magna ipsum vitae purus congue and efficitur ipsum primis in cubilia laoreet
