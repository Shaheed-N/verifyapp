...
export default function Section3() {
	return (
		<>
			...
			<section id="features" className="pt-100 features-2 features-section division">
				<div className="container">
					...
					<div className="fbox-wrapper">
						<div className="row row-cols-1 row-cols-md-2 rows-4">
							{/* FEATURE BOX #1 */}
							<div className="col">
							...
							<div className="col">
								<div className="fbox-2 fb-3 wow animate__animated animate__fadeInUp animate__delay-1">
									...
									<div className="fbox-ico-wrap ico-55">
										<div className="shape-ico color--theme-2">
											{/* Vector Icon */}
											<span className="flaticon-push-pin" />
											{/* Shape */}
											<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
												<path d="M66.1,-32.6C77.9,-17.7,74.4,11.6,60.8,35.7C47.2,59.7,23.6,78.5,2.8,76.9C-18,75.2,-35.9,53.2,-47.7,30.1C-59.5,7.1,-65.1,-16.9,-56.1,-30.1C-47.1,-43.4,-23.6,-46,1.8,-47C27.2,-48.1,54.3,-47.6,66.1,-32.6Z" transform="translate(100 100)" />
											</svg>
							...
							<div className="col">
								<div className="fbox-2 fb-4 wow animate__animated animate__fadeInUp animate__delay-2">
									...
									<div className="fbox-ico-wrap ico-55">
										<div className="shape-ico color--theme-2">
											{/* Vector Icon */}
											<span className="flaticon-audio-message" />
											{/* Shape */}
											<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
												<path d="M66.1,-32.6C77.9,-17.7,74.4,11.6,60.8,35.7C47.2,59.7,23.6,78.5,2.8,76.9C-18,75.2,-35.9,53.2,-47.7,30.1C-59.5,7.1,-65.1,-16.9,-56.1,-30.1C-47.1,-43.4,-23.6,-46,1.8,-47C27.2,-48.1,54.3,-47.6,66.1,-32.6Z" transform="translate(100 100)" />
											</svg>
							...
							{/* FEATURE BOX #7 */}
							<div className="col">
								<div className="fbox-2 fb-7 wow animate__animated animate__fadeInUp animate__delay-1">
									{/* Icon */}
									<div className="fbox-ico-wrap ico-55">
										<div className="shape-ico color--theme-2">
											{/* Vector Icon */}
							...
							{/* FEATURE BOX #8 */}
							<div className="col">
								<div className="fbox-2 fb-8 wow animate__animated animate__fadeInUp animate__delay-2">
									{/* Icon */}
									<div className="fbox-ico-wrap ico-55">
										<div className="shape-ico color--theme-2">
											{/* Vector Icon */}
											<span className="flaticon-data" />
											{/* Shape */}
											<svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
												<path d="M66.1,-32.6C77.9,-17.7,74.4,11.6,60.8,35.7C47.2,59.7,23.6,78.5,2.8,76.9C-18,75.2,-35.9,53.2,-47.7,30.1C-59.5,7.1,-65.1,-16.9,-56.1,-30.1C-47.1,-43.4,-23.6,-46,1.8,-47C27.2,-48.1,54.3,-47.6,66.1,-32.6Z" transform="translate(100 100)" />
											</svg>
					...
					<div className="features-2-download text-center wow animate__animated animate__fadeInUp">
						<div className="row justify-content-center">
							<div className="col-md-6 col-lg-5">
								{/* STORE BADGES */}
								<div className="stores-badge badge-img-xl">
									{/* AppStore */}
									<Link href="#" className="store">
										<img className="appstore" src="/images/store_badges/appstore.png" alt="appstore-badge" />
									</Link>
									{/* Google Play 
									<Link href="#" class="store">
										<img class="googleplay" src="/images/store_badges/googleplay.png" alt="googleplay-badge">
									</Link> */}
								</div>	{/* END STORE BADGES */}
								{/* Text */}
								<p className="p-sm">Buy once, use forever. No subscriptions, no ads. <br /> Just a one-time purchase and
									Pintex is yours, forever.
								</p>
							</div>
						</div>
					</div>
