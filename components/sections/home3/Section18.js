			...
			<section id="download" className="banner-5 banner-section">
				<div className="container">
					...
					<div className="banner-5-wrapper">
						<div className="banner-overlay bg--02 bg--fixed r-24">
							<div className="row d-flex align-items-center">
								{/* BANNER TEXT */}
								<div className="col-md-6">
									<div className="banner-5-txt color--white left-column wow animate__animated animate__fadeInUp animate__delay-1">
										{/* Title */}
