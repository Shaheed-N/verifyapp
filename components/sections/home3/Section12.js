		...
		<>
			...
			<section className="pt-100 features-5 features-section">
				<div className="container">
					{/* FEATURES WRAPPER */}
					<div className="fbox-5-wrapper bg--03 r-24 text-center">
						{/* SECTION TITLE */}
						<div className="row justify-content-center">
							<div className="col-lg-11 col-xl-10">
								<div className="section-title mb-60 text-center">
									{/* Title */}
									<h2 className="h2-xl">One-Stop Solutions</h2>
									{/* Text */}
						...
						<div className="row d-flex align-items-center">
							...
							<div className="col-md-6">
								<div className="fbox-5 fb-1 bg--white r-24 block--shadow wow animate__animated animate__fadeInUp animate__delay-1">
									...
									<div className="fbox-5-img">
										<img className="img-fluid" src="/images/f_03.png" alt="feature-image" />
									</div>
									{/* TEXT */}
									<div className="fbox-txt">
										{/* Title */}
										<h5 className="h5-md">Easy to Use</h5>
										{/* Text */}
										<p className="mb-0">Lacinia quaerat ipsum and congue porttitor ipsum and cursus quaerat neque
											cursus
										</p>
									</div>
								</div>
							...
							<div className="col-md-6">
								<div className="fbox-5 fb-2 bg--white r-24 block--shadow wow animate__animated animate__fadeInUp animate__delay-2">
									...
									<div className="fbox-txt">
										{/* Title */}
										<h5 className="h5-md">Focused on Privacy</h5>
										{/* Text */}
