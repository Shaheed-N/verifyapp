					...
					<div className="row d-flex align-items-center">
						...
						<div className="col-md-6">
							<div className="txt-block right-column wow animate__animated animate__fadeInLeft">
								{/* Title */}
								<h2 className="h2-md">Organize your files better with Pintex</h2>
								{/* Text */}
								...
								<div className="txt-box">
									{/* Title */}
									<h5 className="h5-lg">Organize with ease</h5>
									{/* Text */}
									<ul className="simple-list">
										<li className="list-item">
											<p>Tempor sapien quaerat ipsum laoreet purus dolor a sapien turpis ultrice pulvinar
												congue aliquam an ispum congue
											</p>
										</li>
										<li className="list-item">
											<p className="mb-0">Tempor sapien quaerat ipsum laoreet purus and sapien dolor diam ultrice
												ipsum aliquam congue and dolor cursus dolor cursus justo congue ipsum in purus sapien
												blandit
											</p>
										</li>
									</ul>
