					...
					<div className="row d-flex align-items-center">
						...
						<div className="col-md-6">
							<div className="img-block left-column wow animate__animated animate__fadeInRight">
								<img className="img-fluid" src="/images/img-03d.png" alt="content-image" />
							</div>
						</div>
						{/* TEXT BLOCK */}
						<div className="col-md-6">
								...
								<div className="accordion-1 accordion-wrapper">
									<ul className="accordion">
										...
										<li className="accordion-item is-active">
											{/* Title */}
											<div className="accordion-thumb"><h5 className="h5-lg">Sync Across Accounts</h5></div>
											{/* Text */}
										...
										<li className="accordion-item">
											{/* Title */}
											<div className="accordion-thumb"><h5 className="h5-lg">Editing Tools and Exports</h5></div>
											{/* Text */}
											<div className="accordion-panel">
										...
										<li className="accordion-item">
											{/* Title */}
											<div className="accordion-thumb"><h5 className="h5-lg">No Personal Data Collected</h5></div>
											{/* Text */}
											<div className="accordion-panel">
