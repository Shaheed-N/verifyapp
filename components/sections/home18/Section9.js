...
export default function Section9() {
	return (
		<>
			...
			<section id="integrations" className="pt-100 integrations-2 integrations-section division">
					...
					<div className="int-2-wrapper">
						<div className="row row-cols-2 row-cols-sm-3 row-cols-md-4 row-cols-lg-6">
							...
							<div className="col">
								<Link href="#">
									<div className="int_tool-2 bg--white r-12 wow wow animate__animated animate__fadeInUp">
										<img className="img-fluid" src="/images/png_icons/zendesk-dark.png" alt="tool-logo" />
										<h6>Zendesk</h6>
									</div>
								</Link>
