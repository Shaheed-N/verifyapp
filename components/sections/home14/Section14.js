...
export default function Section14() {
	return (
		<>
			...
			<section id="reviews" className="py-100 reviews-3 reviews-section">
					...
					<div className="row">
						<div className="col">
							<div className="reviews-btn">
								<Link href="/reviews" className="btn r-08 btn-md btn--tra-black hover--theme">Read More Reviews</Link>
							</div>
						</div>
					</div>{/* END TESTIMONIALS BUTTON */}
				</div>	   {/* End container */}
			</section>
