					...
					<div className="row justify-content-center">
						<div className="col-md-8">
							<div className="section-title text-center mb-60">
								{/* Title */}
								<h2 className="h2-xl">Send money to anyone around the world</h2>
								{/* Text */}
					...
					<div className="row">
						<div className="col">
							<div className="img-block-btn wow animate__animated animate__fadeInUp">
								{/* Button */}
								<VideoPopup className="video-popup1 btn btn-md r-10 btn--theme hover--tra-black ico-20 ico-right">See Pintex in Action <span className="flaticon-play" /></VideoPopup>
								{/* Advantages List */}
