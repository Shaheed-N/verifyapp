		...
		<>
			...
			<section id="how-it-works" className="pt-100 bc-03 ws-wrapper content-section">
				<div className="container">
					<div className="bc-03-wrapper bg--tra-violet-red hidd r-24">
							...
							<div className="row justify-content-center">
								<div className="col-md-10 col-lg-9">
									<div className="section-title text-center wow animate__animated animate__fadeInUp">
										{/* Title */}
										<h2 className="h2-lg">Send money and make your purchases easily</h2>
										{/* Text */}
							...
							<div className="row justify-content-center">
								<div className="col">
									<div className="bc-3-img video-preview wow animate__animated animate__fadeInUp">
										...
										{/* Preview Image */}
										<img className="img-fluid" src="/images/tablet-03.png" alt="content-image" />
									</div>
								</div>
							</div>
