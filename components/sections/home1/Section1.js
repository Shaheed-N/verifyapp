				...
				<div className="container">
					<div className="row d-flex align-items-center">
						...
						<div className="col-md-6">
							<div className="hero-1-txt color--white wow animate__animated animate__fadeInRight">
								{/* Title */}
								<h2>Share photos that capture your best memories</h2>
								{/* Text */}
						...
						{/* HERO IMAGE */}
						<div className="col-md-6">
							<div className="hero-1-img wow animate__animated animate__fadeInLeft">
