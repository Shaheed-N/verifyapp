					...
					<div className="row">
						<div className="col">
							<div className="img-block-btn wow animate__animated animate__fadeInUp">
								{/* Button */}
								<VideoPopup className="video-popup1 btn btn-md r-36 btn--theme hover--tra-black ico-20 ico-right">See Pintex in Action <span className="flaticon-play" /></VideoPopup>
								{/* Advantages List */}
