		...
		<>
			...
			<section className="pt-30 features-4 features-section">
				<div className="container">
					<div className="fbox-4-wrapper bg--whitesmoke r-24 wow animate__animated animate__fadeInUp animate__delay-1">
						<div className="row d-flex align-items-center">
							{/* TEXT BLOCK */}
							<div className="col-md-6">
								<div className="fbox-4-txt right-column">
									{/* Section ID */}
									<span className="section-id">Stickers &amp; Themes</span>
									{/* Title */}
