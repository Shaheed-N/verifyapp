					...
					<div className="row justify-content-center">
						<div className="col-md-8">
							<div className="section-title text-center mb-60">
								{/* Title */}
								<h2 className="h2-xl">Create Better &amp; Faster</h2>
								{/* Text */}
					...
					<div className="row">
						<div className="col">
							<div className="img-block wow animate__animated animate__fadeInUp">
								<img className="img-fluid" src="/images/img-21.png" alt="content-image" />
							</div>
						</div>
					</div>
					{/* ACTION BUTTON */}
					<div className="row">
						<div className="col">
							<div className="img-block-btn wow animate__animated animate__fadeInUp">
								{/* Button */}
								<Link href="#download" className="btn btn-md r-08 btn--theme hover--tra-black">Get started - it's free</Link>
								{/* Advantages List */}
