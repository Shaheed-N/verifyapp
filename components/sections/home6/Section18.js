...
export default function Section18() {
	return (
		<>
			...
			<section id="pricing" className="py-100 pricing-2 pricing-section division">
					...
					<div className="row justify-content-center">
						<div className="col-lg-9">
							<div className="pricing-notice wow animate__animated animate__fadeInUp">
								{/* Button */}
								<Link href="/download" className="btn r-08 btn--tra-black hover--theme">Get Started For Free</Link>
							</div>
						</div>
