				...
				<div className="header-wrapper">
					...
					<div className="wsmainfull menu clearfix">
						<div className="wsmainwp clearfix">
							...
							{/* HEADER WHITE LOGO */}
							<div className="desktoplogo">
								<Link href="#hero-17" className="logo-white"><img src="/images/logo-white.png" alt="logo" /></Link>
							</div>
							{/* MAIN MENU */}
							<nav className="wsmenu clearfix">
								<ul className="wsmenu-list nav-theme">
									...
									<li className="nl-simple mobile-last-link" aria-haspopup="true">
										<Link href="#download" className="btn r-36 ico-20 ico-right btn--tra-black hover--theme last-link">Download <span className="flaticon-download-file" /></Link>
									</li>
								</ul>
							</nav>	{/* END MAIN MENU */}
						</div>
