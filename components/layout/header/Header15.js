					...
					<div className="wsmainfull menu clearfix">
						<div className="wsmainwp clearfix">
							...
							<div className="desktoplogo">
								<Link href="#hero-15" className="logo-black">
									<img src="/images/logo.png" alt="logo" />
								</Link>
							</div>
							{/* HEADER WHITE LOGO */}
							<div className="desktoplogo">
								<Link href="#hero-15" className="logo-white"><img src="/images/logo-white.png" alt="logo" /></Link>
							</div>
							{/* MAIN MENU */}
							<nav className="wsmenu clearfix">
								<ul className="wsmenu-list nav-theme">
									...
									{/* SIMPLE NAVIGATION LINK */}
									<li className="nl-simple" aria-haspopup="true">
										<Link href="/blog-listing" className="h-link">Blog</Link>
									</li>
									{/* APPSTORE BADGE */}
									<li className="nl-simple" aria-haspopup="true">
										<Link href="#" className="store header-store">
											<img className="appstore-header" src="/images/store_badges/appstore.png" alt="appstore-logo" />
										</Link>
									</li>
								</ul>
							</nav>	{/* END MAIN MENU */}
