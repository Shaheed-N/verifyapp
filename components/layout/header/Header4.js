					...
					<div className="wsmainfull menu clearfix">
						<div className="wsmainwp clearfix">
							...
							<div className="desktoplogo">
								<Link href="#hero-4" className="logo-black">
									<img src="/images/logo.png" alt="logo" />
								</Link>
							</div>
							{/* HEADER WHITE LOGO */}
							<div className="desktoplogo">
								<Link href="#hero-4" className="logo-white"><img src="/images/logo-white.png" alt="logo" /></Link>
							</div>
							{/* MAIN MENU */}
							<nav className="wsmenu clearfix">
								<ul className="wsmenu-list nav-theme">
									...
									<li className="nl-simple mobile-last-link" aria-haspopup="true">
										<Link href="/signup" className="btn r-36 btn--tra-black hover--theme last-link">Try for free</Link>
									</li>
								</ul>
							</nav>	{/* END MAIN MENU */}
						</div>
