...
export default function Header2({ scroll, isMobileMenu, handleMobileMenu }) {
	return (
		<>
			...
			<header id="header" className="hidden-nav tra-menu navbar-dark white-scroll">
					...
					<div className="wsmainfull menu clearfix">
						<div className="wsmainwp clearfix">
							...
							<div className="desktoplogo">
								<Link href="#hero-18" className="logo-black">
									<img src="/images/logo-white.png" alt="logo" />
								</Link>
							</div>
							{/* HEADER WHITE LOGO */}
							<div className="desktoplogo">
								<Link href="#hero-18" className="logo-white"><img src="/images/logo-white.png" alt="logo" /></Link>
							</div>
							{/* MAIN MENU */}
								...
								<ul className="wsmenu-list nav-theme">
									...
									<li aria-haspopup="true">
										...
										<ul className="sub-menu ico-10">
											...
											<li aria-haspopup="true" className="h-link"><Link href="/changelog">Release Notes</Link></li>
										</ul>
									</li>
									...
									{/* SIMPLE NAVIGATION LINK */}
									<li className="nl-simple" aria-haspopup="true">
										<Link href="/pricing-2" className="h-link">Pricing</Link>
									</li>
									{/* DROPDOWN SUB MENU */}
									<li aria-haspopup="true">
									...
									<li className="nl-simple mobile-last-link" aria-haspopup="true">
										<Link href="#download" className="btn r-10 btn--theme hover--tra-white last-link">Get Started</Link>
									</li>
								</ul>
							</nav>	{/* END MAIN MENU */}
						</div>
